  ...
  return (
    <div className="h-screen flex justify-center items-center bg-gradient-to-r from-[#556B2F] to-[#A9C18D]">
      <form
        ...
        className="bg-white/90 backdrop-blur-md p-8 rounded-2xl shadow-xl w-96 space-y-5"
      >
        <h2
          className="text-3xl font-bold text-center text-[#3B4B1B]"
        ...
        <button
          type="submit"
          className="w-full bg-[#556B2F] hover:bg-[#3B4B1B] text-[#FDF6E3] font-semibold py-2 rounded-lg transition duration-200 cursor-pointer"
        >
          Register
        </button>
